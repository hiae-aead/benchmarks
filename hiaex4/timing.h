...
get_cpu_frequency(void)
{
    ...
    for (int i = 0; i < iterations; i++) {
        ...
        uint64_t cycles  = timer_elapsed_cycles(&timer);
...
stats_create(size_t initial_capacity)
{
...
static inline void
stats_add(stats_t *stats, double value)
{
