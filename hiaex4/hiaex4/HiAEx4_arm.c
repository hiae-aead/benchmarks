...
static void
HiAEx4_enc_partial_noupdate_arm(HiAEx4_state_t *state_opaque,
                                uint8_t        *ci,
                                const uint8_t  *mi,
                                size_t          size)
{
...
static void
HiAEx4_dec_partial_noupdate_arm(HiAEx4_state_t *state_opaque,
                                uint8_t        *mi,
                                const uint8_t  *ci,
                                size_t          size)
{
...
static int
HiAEx4_decrypt_arm(const uint8_t *key,
                   const uint8_t *nonce,
                   uint8_t       *msg,
                   const uint8_t *ct,
                   size_t         ct_len,
